class Renderer {
    ...
    drawGraph(r) {
        ...
        this.context.lineTo(this.xAxis, this.yAxis - 2 - (r / 2) * this.scaleY);
        ...
        //2 четверть
        this.context.beginPath();
        this.context.fillRect(this.xAxis, this.yAxis, -(r / 2) * this.scaleX + 1,
            -r * this.scaleY - 1);
        this.context.closePath();

        //3 четверть
        this.context.beginPath();
        this.context.arc(this.xAxis, this.yAxis, r * this.scaleX + 1, 0.5 * Math.PI, Math.PI);
        this.context.lineTo(this.xAxis, this.yAxis);
        this.context.fill();
        this.context.stroke();
        this.context.closePath();
